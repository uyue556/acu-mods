...
public:
    ...
    virtual ResultEditedKeyframe_t DrawEditor(byte* trackdata) override
    {
        ...
        auto EditTranslation = [&](uint32 keyframeIdx) -> ResultEditedKeyframe_t
        {
            ...
            buf.appendf("帧：%d，时间：%f", keyframeFrame, keyframeTimeFlt);
