...
fs::path FindPreferredFontFile()
{
    ...
    fs::path preferredFont =        fontsDir / "msyh.ttc";          // Microsoft YaHei, covers CJK
    fs::path secondPreferredFont =  fontsDir / "CascadiaCode.ttf";  // Not present on Windows 8
    fs::path thirdPreferredFont =   fontsDir / "consola.ttf";       // Or maybe the Bold version, the consolab.ttf?
    std::error_code ec;
    ...
    if (fs::is_regular_file(thirdPreferredFont, ec))    return thirdPreferredFont;
    return {};
}
void SetupFonts()
{
